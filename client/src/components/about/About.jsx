      ...
      <div className="container">
        <div className="about_section_2">
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="about_taital_box">
                ...
                <p className=" about_text">At <span className='strong'>Coffee Lovers</span>, we believe that coffee is more than just a beverage; it&apos;s an experience that brings people together. Founded in 1993, our journey began with a passion for exceptional coffee and a commitment to sustainability. We source our beans from the finest coffee-growing regions around the world, partnering with local farmers who share our dedication to quality and ethical practices.</p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="image_iman"><img src="../../../public/images/Espressolab-01.png" className="about_img" /></div>
            </div>
          </div>
          <div className="row">
          <div className="col-md-6">
              <div className="image_iman"><img src="../../../public/images/coffeeBeans.jpg" className="about_img" /></div>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="image_iman"><img src="../../../public/images/caputsino.jpg" className="about_img" /></div>
            </div>
          </div>
          ...
          <div className="col-md-6">
            ...
            <div className="col-md-6">
              <div className="about_taital_box">
                ...
                <p className=" about_text">At <span className='strong'>Coffee Lovers</span>, we believe in giving back. A portion of our proceeds goes to initiatives that support farmers, sustainable agriculture, and community development. We are committed to fostering positive change within the coffee industry and beyond.</p>
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className='cheers'>
            ...
            <p>Cheers,<br />
              The <span className='strong'>Coffee Lovers</span> Team</p>
